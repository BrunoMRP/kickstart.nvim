...
vim.keymap.set('n', '<up>', '<cmd>echo "Disabled"<CR>')
vim.keymap.set('n', '<down>', '<cmd>echo "Disabled"<CR>')
...
-- Leader P to paste without replacing default register
...
vim.api.nvim_create_autocmd('VimEnter', {
  desc = 'Create scroll bar',
  group = vim.api.nvim_create_augroup('minimap-scrollbar', { clear = true }),
  callback = function()
    MiniMap.open()
  end,
})
...
require('lazy').setup({
  ...
  -- Opens file in last visited line
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'go', 'python', 'json' },
